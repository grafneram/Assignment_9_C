...
int main(int argc, char *argv[]) {
    ...
    if (argc < 2) {
        printf("Command line usage: <task choice> <arg1> <arg2> .. ect");
        printf("\nAvailable tasks:\n");
        printf("calc: Performs basic arithmetic operations (+, -, *, /,!, ^)\n");
        printf("si: performs simple interest. <interest principal> <rate %> <years>");
        printf("area: calculates the area of rectangle or circle");
        return 1;
    }
